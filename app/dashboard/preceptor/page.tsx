      ...
      <motion.div className="space-y-8" initial="hidden" animate="visible">
        ...
        >
          ...
          <div className="flex items-center gap-3 mt-2">
            ...
            <span
              className={`text-xs px-2 py-1 rounded border ${verification === "verified" ? "bg-success/10 text-success border-success/30" : "bg-warning/10 text-warning border-warning/30"}`}
            >
